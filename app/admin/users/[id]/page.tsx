...
const user = {
  ...
  emergencyContact: "Amit Sharma (+91 9876543219)",
  gameHistory: [
    {
      id: 1,
      ...
      location: "Sree Cauvery School, Indiranagar",
      status: "upcoming",
      paymentStatus: "paid",
      amount: "₹200",
    },
  ...
  paymentHistory: [
    {
      ...
      method: "Credit Card",
      status: "successful",
      description: "Payment for 2 games",
    },
    {
      id: 2,
      date: "April 22, 2025",
      ...
      method: "UPI",
      status: "successful",
      description: "Payment for Weekday Evening Run",
    },
    {
      id: 3,
      date: "April 18, 2025",
      ...
      method: "UPI",
      status: "successful",
      description: "Payment for Saturday Morning Pickup",
    },
    {
      id: 4,
      date: "April 12, 2025",
      ...
      method: "Credit Card",
      status: "successful",
      description: "Payment for Sunday Pro Run",
    },
    {
      id: 5,
      date: "April 10, 2025",
  ...
  activityLog: [
    {
      ...
      action: "Registered for Saturday Morning Pickup",
      type: "registration",
    },
    {
      id: 2,
      date: "May 1, 2025 - 10:28 AM",
      action: "Registered for Sunday Pro Run",
      type: "registration",
    },
    {
      id: 3,
      date: "May 1, 2025 - 10:25 AM",
      action: "Made payment of ₹450",
      type: "payment",
    },
    {
      id: 4,
      date: "April 24, 2025 - 6:45 PM",
      action: "Attended Weekday Evening Run",
      type: "attendance",
    },
    {
      id: 5,
      date: "April 22, 2025 - 9:15 AM",
      action: "Made payment of ₹200",
      type: "payment",
    },
    {
      id: 6,
      date: "April 22, 2025 - 9:10 AM",
      action: "Registered for Weekday Evening Run",
      type: "registration",
    },
    {
      id: 7,
